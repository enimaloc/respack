package fr.divineexodus.server.texture.font;
...
public abstract class Provider {
    ...
    public static Bitmap bitmap(NamespaceID namespace, int ascent) {
        return new Bitmap(namespace, ascent);
    }

    public static Provider bitmap(NamespaceID namespace, int ascent, int height) {
    ...
    public static class Bitmap extends Provider {
        ...
        public Bitmap(NamespaceID namespace, int ascent) {
