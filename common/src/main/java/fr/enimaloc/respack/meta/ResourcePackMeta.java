package fr.enimaloc.respack.meta;

import com.google.gson.JsonArray;
import com.google.gson.JsonObject;
import fr.enimaloc.respack.lang.MCLocale;
import fr.enimaloc.utils.Either;
...
import static fr.enimaloc.utils.MinecraftVersion.*;
    ...
    public JsonObject toJson() {
        ...
        if (description != null) {
            if (description.isLeft()) {
                pack.addProperty("description", description.getLeft());
            } else {
                pack.add("description", description.getRight());
            }
        }
        json.add("pack", pack);
